/**
 * Bridge ramp railing, right: the parapet up the right-hand flank, as you look up the climb from the bank — the west flank of an unturned ramp, which is the edge a turn of one stands it on. It steps with the
 ...
 * edge rail. Drawn along the north edge, it falls towards +x, which a turn of one swings round to run up the ramp's west flank; the ramp's
